...
namespace d3 {
    d3Image::d3Image(unsigned char *data,
                     d3Size depth,
                     d3Size width,
                     d3Size height,
                     d3PixelFormat pixel_format)
    ...
    d3Image::d3Image(const char* filename) {
    ...
    void d3Image::saveToFile(const char* filename) const {
        png_byte color_type;
